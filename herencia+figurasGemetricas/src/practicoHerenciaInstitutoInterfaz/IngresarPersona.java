...
public class IngresarPersona extends javax.swing.JFrame {
     ...
     */
    public IngresarPersona(Instituto i) {
        initComponents();
    }
    ...
    if(txtFieldNombre.getText().isBlank() 
           ...
           && txtFieldFnac.getText().isBlank()){
            ...
            JOptionPane.showMessageDialog(this, "El TIPODEPERSONA fue agregado correctamente");
            Tipodepersona persona = new Tipodepersona(nombre, apellido, ci, fnac,etc);
            i.agregar(persona);
            this.dispose();
        }
    
    //lo qeu falta para que funcione es que en el boton que va a llamar al bicho este se añada al modelo
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new IngresarPersona(i).setVisible(true));
    }
